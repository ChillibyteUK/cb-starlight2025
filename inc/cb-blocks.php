    ...
    if ( function_exists( 'acf_register_block_type' ) ) {
        ...
        acf_register_block_type(
            array(
                ...
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-doclist.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_related_products',
                'title'           => __( 'CB Related Products' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-related-products.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_product_spec',
                'title'           => __( 'CB Product Spec' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-product-spec.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_product_index',
                'title'           => __( 'CB Product Index' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-product-index.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_product_showcase',
                'title'           => __( 'CB Product Showcase' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-product-showcase.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_gallery_pushthrough',
                'title'           => __( 'CB Gallery Pushthrough' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-gallery-pushthrough.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
