...
function widgets_init() {
    ...
    register_nav_menus(
        array(
            'primary_nav'  => __( 'Primary Nav', 'cb-starlight2025' ),
            'footer_menu1' => __( 'Footer Nav 1', 'cb-starlight2025' ),
            'footer_menu2' => __( 'Footer Nav 2', 'cb-starlight2025' ),
            'footer_menu3' => __( 'Footer Nav 3', 'cb-starlight2025' ),
        )
    );
