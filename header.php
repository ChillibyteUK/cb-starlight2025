...
<head>
    ...
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/open-sans-v44-latin-300.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/open-sans-v44-latin-600.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
...
<header id="wrapper-navbar" class="fixed-top p-0">
	<nav class="navbar navbar-expand-lg py-3">
		<div class="container gap-6">
            <div class="d-flex justify-content-between w-100 w-lg-auto align-items-center py-3 py-lg-0 pe-5">
                <div class="logo-container"><a href="/" class="logo navbar-brand" aria-label="Starlight Homepage"></a></div>
